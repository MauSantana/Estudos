...
select * from aluno;
select * from aluno where ra between 1202020 and 1202030;
...
-- Atribuindo valores para a tabela fkCurso
...
-- Exibir os dados dos alunos correspondentes 
select * from Aluno, Curso where fkCurso = idCurso;

-- Exibir os dados dos alunos correspondentes, sem duplicar o fkCurso/idCurso
